                            ...
                            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user"
                               ...
                               aria-expanded="false">
                                <div class="user-nav d-sm-flex d-none">
                                    <span class="user-name font-weight-bolder"> {{ !is_null(auth()->guard('admin')->user()) ? auth()->guard('admin')->user()->first_name : '' }} </span>
                                    <span class="user-status">Admin</span>
                                </div>
                                <span class="avatar">
{{--                                  @if(!is_null(auth()->guard('admin')->user()->avatar) and !empty(auth()->guard('admin')->user()->avatar))--}}
{{--                                        <img class="round" src="{{ auth()->guard('admin')->user()->avatar }}" alt="avatar" height="40"--}}
{{--                                             width="40">--}}
{{--                                    @else--}}
...
{{--                                  @endif--}}
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                                ...
                                <form id="logout-form" action="{{ route('admin-log-out') }}" method="POST"
                                      class="hidden">
                                    {{ csrf_field() }}
                                </form>
                            </div>
