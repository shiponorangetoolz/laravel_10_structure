...
$(function () {
    ...
    (function () {
       ...
       ==========================================================================================*/
        ...
        /*=========================================================================================
           Action : User profile information update
           Description : Form Validation and submit form for update admin info
           Backend Route Name : user-profile-information-data-update
       ==========================================================================================*/
            ...
            profileManage.profileInformationForm.on('submit', function (e) {
                ...
                if (isValid) {
                    ...
                    setTimeout(function () {
                        ...
                        let response = $.makeAjaxRequest('user-profile-information-data-update', "POST", profileManage.profileInformationFormData)
        ...
        /*=========================================================================================
           ...
           Backend Route Name : user-reset-password-update
       ==========================================================================================*/
            ...
            profileManage.profileManageresetPasswordForm.on('submit', function (e) {
                ...
                if (isValid) {
                    ...
                    setTimeout(function () {
                        ...
                        let response = $.makeAjaxRequest('user-reset-password-update', "POST", profileManage.profileManageresetPasswordFormData)
                        if (response.status === $.Response.HTTP_OK) {
                            $.showSuccessAlert(response.message)
                        }else{
                            $.showSuccessAlert(response.message)
        ...
        /*=========================================================================================
          Action : User profile image change
